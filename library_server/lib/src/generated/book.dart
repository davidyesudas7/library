...
abstract class Book implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  static BookInclude include({_i2.CategoryInclude? category}) {
    return BookInclude._(category: category);
  }
...
class BookUpdateTable extends _i1.UpdateTable<BookTable> {
  ...
  _i1.ColumnValue<bool, bool> isAvailableOnline(bool value) => _i1.ColumnValue(
    table.isAvailableOnline,
    value,
  );

  _i1.ColumnValue<bool, bool> isAvailableOffline(bool value) => _i1.ColumnValue(
    table.isAvailableOffline,
    value,
  );

  _i1.ColumnValue<String, String> pdfUrl(String? value) => _i1.ColumnValue(
    table.pdfUrl,
    value,
  );
...
class BookTable extends _i1.Table<int?> {
  BookTable({super.tableRelation}) : super(tableName: 'book') {
    ...
    isAvailableOffline = _i1.ColumnBool(
      'isAvailableOffline',
      this,
    );
  ...
  late final _i1.ColumnBool isAvailableOffline;
...
class BookInclude extends _i1.IncludeObject {
  BookInclude._({_i2.CategoryInclude? category}) {
    _category = category;
  }
...
class BookAttachRowRepository {
  ...
  /// Creates a relation between the given [Book] and [Category]
  /// by setting the [Book]'s foreign key `categoryId` to refer to the [Category].
